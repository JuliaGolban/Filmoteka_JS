 ...
 * limitations under the License.
 */
const A="firebase-heartbeat-store";let O=null;function R(){return O||(O=(0,a.openDB)("firebase-heartbeat-database",1,{upgrade:(e,t)=>{if(0===t)e.createObjectStore(A)}}).catch((e=>{throw b.create("idb-open",{originalErrorMessage:e.message})}))),O}async function N(e,t){var n;try{const n=(await R()).transaction(A,"readwrite"),r=n.objectStore(A);return await r.put(t,k(e)),n.done}catch(e){if(e instanceof s.FirebaseError)d.warn(e.message);else{const t=b.create("idb-set",{originalErrorMessage:null===(n=e)||void 0===n?void 0:n.message});d.warn(t.message)}}}function k(e){return`${e.name}!${e.options.appId}`}
/**
 * @license
 * Copyright 2021 Google LLC
 *
 ...
 * limitations under the License.
 */
function U(e){return e&&e._delegate?e._delegate:e}})),o.register("7vF8m",(function(t,n){e(t.exports,"LogLevel",(function(){return i})),e(t.exports,"Logger",(function(){return l})),e(t.exports,"setLogLevel",(function(){return d})),e(t.exports,"setUserLogHandler",(function(){return h}));
/**
 * @license
 * Copyright 2017 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const xt=new O(3e4,6e4);function Mt(){const e=Qe().___jsl;if(null==e?void 0:e.H)for(const t of Object.keys(e.H))if(e.H[t].r=e.H[t].r||[],e.H[t].L=e.H[t].L||[],e.H[t].r=[...e.H[t].L],e.CP)for(let t=0;t<e.CP.length;t++)e.CP[t]=null}let Bt=null;function Ft(e){return Bt=Bt||function(e){return new Promise(((t,n)=>{var r,i,o;function s(){Mt(),gapi.load("gapi.iframes",{callback:()=>{t(gapi.iframes.getContext())},ontimeout:()=>{Mt(),n(m(e,"network-request-failed"))},timeout:xt.get()})}if(null===(i=null===(r=Qe().gapi)||void 0===r?void 0:r.iframes)||void 0===i?void 0:i.Iframe)t(gapi.iframes.getContext());else{if(!(null===(o=Qe().gapi)||void 0===o?void 0:o.load)){const t=dt("iframefcb");return Qe()[t]=()=>{gapi.load?s():n(m(e,"network-request-failed"))},lt(`https://apis.google.com/js/api.js?onload=${t}`).catch((e=>n(e)))}s()}})).catch((e=>{throw Bt=null,e}))}(e),Bt}
/**
 * @license
 * Copyright 2020 Google LLC.
 *
