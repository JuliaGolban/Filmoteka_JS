 ...
 * limitations under the License.
 */
const O="firebase-heartbeat-store";let A=null;function R(){return A||(A=(0,a.openDB)("firebase-heartbeat-database",1,{upgrade:(e,t)=>{if(0===t)e.createObjectStore(O)}}).catch((e=>{throw b.create("idb-open",{originalErrorMessage:e.message})}))),A}async function N(e,t){var n;try{const n=(await R()).transaction(O,"readwrite"),r=n.objectStore(O);return await r.put(t,L(e)),n.done}catch(e){if(e instanceof s.FirebaseError)d.warn(e.message);else{const t=b.create("idb-set",{originalErrorMessage:null===(n=e)||void 0===n?void 0:n.message});d.warn(t.message)}}}function L(e){return`${e.name}!${e.options.appId}`}
/**
 * @license
 * Copyright 2021 Google LLC
 *
